      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-5 mt-8">
        ...
        >
          ...
          <div className="relative z-10">
            <h3 className="text-xl sm:text-2xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-gray-900 to-gray-400 dark:from-white dark:to-gray-500 mb-2 block">
              달빛어린이병원 & 심야약국 찾기
            </h3>
