...
export default function HealthCheckPage() {
  ...
  return (
    <div className="flex flex-col h-[700px] max-h-[80vh] w-full bg-gray-50 dark:bg-[#121212] overflow-hidden mt-2 rounded-none sm:rounded-none shadow-2xl border border-gray-100 dark:border-gray-800">
      {/* 1. 헤더 바 & 동네 선택 */}
      ...
      <div className="bg-white dark:bg-[#1e1e1e] p-4 border-b border-gray-200 dark:border-gray-800 shrink-0 z-10 shadow-2xl">
        ...
        <div className="flex gap-2">
          <input 
            ...
            className="flex-1 bg-gray-100 dark:bg-[#2d2e30] border-none rounded-none px-4 py-2 text-sm focus:ring-2 focus:ring-[#FF6B6B] outline-none text-gray-900 dark:text-white"
            value={birthYear}
            onChange={(e) => setBirthYear(e.target.value)}
          />
          <button 
            onClick={calculateCheckup}
            className="bg-[#FF6B6B] text-white px-5 py-2 rounded-none text-sm font-bold shadow-2xl hover:bg-[#ff5252] transition-colors"
          >
            결과 확인
          </button>
        </div>
        ...
        {showResult && (
          <div className="mt-4 p-3 bg-red-50 dark:bg-red-900/20 border border-red-100 dark:border-red-900/30 rounded-none animate-fade-in">
        ...
        {!loading && !error && (
          ...
          >
            ...
            {selectedHospital && (
              ...
              >
                <div className="bg-white dark:bg-[#202124] rounded-none shadow-xl overflow-hidden border border-gray-100 dark:border-gray-800 animate-slide-up">
                  ...
                  <div className="p-4 space-y-3">
                    ...
                    <a 
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="mt-3 w-full block text-center bg-[#FF6B6B]/10 hover:bg-[#FF6B6B]/20 text-[#FF6B6B] font-bold py-2.5 rounded-none text-sm transition-colors"
                    >
                      길찾기
                    </a>
                  </div>
