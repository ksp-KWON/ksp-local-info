...
export default function AdminDashboardClient() {
  ...
  return (
    <div className="flex-1 flex flex-col bg-gray-50 dark:bg-zinc-950 font-sans h-full overflow-hidden relative">
      ...
      {/* Top Navbar */}
      <nav className="h-14 bg-white dark:bg-zinc-900 border-b border-slate-200 dark:border-zinc-800 flex items-center justify-between px-4 sm:px-6 shrink-0 shadow-sm z-40">
