...
export const BLOG_TONE_TOKENS: Record<BlogTone, ToneColorToken> = {
  purple: {
    ...
    tailwind: {
      ...
      hoverBorder: 'hover:border-purple-500 dark:hover:border-purple-500 hover:shadow-[0_0_50px_rgba(126,34,206,0.40),0_0_20px_rgba(126,34,206,0.22)]',
  ...
  green: {
    ...
    tailwind: {
      ...
      hoverBorder: 'hover:border-emerald-500 dark:hover:border-emerald-500 hover:shadow-[0_0_50px_rgba(4,120,87,0.40),0_0_20px_rgba(4,120,87,0.22)]',
  ...
  blue: {
    ...
    tailwind: {
      ...
      hoverBorder: 'hover:border-sky-500 dark:hover:border-sky-500 hover:shadow-[0_0_50px_rgba(3,105,161,0.40),0_0_20px_rgba(3,105,161,0.22)]',
  ...
  red: {
    ...
    tailwind: {
      ...
      hoverBorder: 'hover:border-rose-500 dark:hover:border-rose-500 hover:shadow-[0_0_50px_rgba(190,18,60,0.40),0_0_20px_rgba(190,18,60,0.22)]',
  ...
  yellow: {
    ...
    tailwind: {
      ...
      hoverBorder: 'hover:border-amber-500 dark:hover:border-amber-500 hover:shadow-[0_0_50px_rgba(180,83,9,0.40),0_0_20px_rgba(180,83,9,0.22)]',
