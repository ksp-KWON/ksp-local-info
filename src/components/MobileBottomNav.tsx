        ...
        <div className="w-full flex flex-col">
                  ...
                  {group.items.map((cat) => {
                    ...
                    return (
                      <Link
                        ...
                        onClick={() => setIsMenuOpen(false)}
                        className="flex items-center gap-2 p-3 bg-white dark:bg-[#1a1c20] rounded-none border border-gray-100 dark:border-gray-800 hover:border-blue-200 dark:hover:border-blue-800 hover:shadow-2xl hover:-translate-y-0.5 transition-all duration-200"
                      >
          ...
          <div className="mt-4 grid grid-cols-2 gap-3">
            <Link
              ...
              onClick={() => setIsMenuOpen(false)}
              className="flex items-center gap-2 p-3 rounded-none bg-blue-50 dark:bg-blue-900/20 border border-blue-100 dark:border-blue-800 text-blue-700 dark:text-blue-300 hover:-translate-y-0.5 hover:shadow-2xl transition-all duration-200"
            >
            ...
            <Link
              ...
              onClick={() => setIsMenuOpen(false)}
              className="flex items-center gap-2 p-3 rounded-none bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-100 dark:border-emerald-800 text-emerald-700 dark:text-emerald-300 hover:-translate-y-0.5 hover:shadow-2xl transition-all duration-200"
            >
