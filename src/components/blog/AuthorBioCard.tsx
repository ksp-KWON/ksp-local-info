      ...
      <div className="relative z-10">
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="mt-3 flex items-center gap-3 text-[12px] text-[var(--google-blue)] font-bold">
              ...
              <span className="text-gray-400 dark:text-gray-500 font-medium">의정부 생활 정보 공식 에디터</span>
            </div>
          </div>
        </div>
      </div>
