...
export default function CommonBox({ tone = 'blue', title, children, icon, headerRight, topElement }: CommonBoxProps) {
  ...
  return (
    <div
      className={`my-6 bg-white dark:bg-[#181a1d] ${token.tailwind.border} ${token.tailwind.hoverBorder} shadow-[0_4px_20px_rgba(0,0,0,0.08)] dark:shadow-[0_4px_20px_rgba(0,0,0,0.45)] hover:shadow-[0_25px_60px_-15px_rgba(0,0,0,0.30),0_10px_25px_-5px_rgba(0,0,0,0.15)] dark:hover:shadow-[0_25px_60px_-15px_rgba(0,0,0,0.95),0_10px_25px_-5px_rgba(0,0,0,0.80)] transition-all duration-300 overflow-hidden rounded-none relative group`}
    >
      {topElement}
