...
export default function EmergencyBottomSheet({ item, activeTab, onClose }: BottomSheetProps) {
  ...
  return (
    <div className="absolute z-30 bottom-4 left-4 right-4 max-w-md mx-auto">
      <div className="bg-white dark:bg-[#181a1d] rounded-none overflow-hidden flex flex-col shadow-[0_14px_44px_rgba(0,0,0,0.18)] dark:shadow-[0_14px_44px_rgba(0,0,0,0.5)] border border-gray-200/90 dark:border-zinc-800">
