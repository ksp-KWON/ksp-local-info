...
export default function BottomSheet({
  ...
  return (
    <>
      ...
      {/* Bottom Sheet */}
      <div 
        className={`${displayClass} fixed ${bottomOffset} left-0 w-full bg-white dark:bg-[#202124] rounded-none border-t border-gray-200/90 dark:border-zinc-800 shadow-2xl ${zIndex} transition-transform duration-300 transform ${isOpen ? 'translate-y-0' : 'translate-y-full'}`}
