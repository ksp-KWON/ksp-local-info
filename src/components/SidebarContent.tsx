  ...
  return (
    <div className="space-y-6">
      ...
      <Link href="/blog?tag=의정부사랑카드" className="block group">
        <div className="bg-white dark:bg-[#1e1f22]  p-5 rounded-none border border-gray-100 dark:border-white/5 shadow-[0_20px_60px_rgba(0,0,0,0.06)] dark:shadow-[0_20px_60px_rgba(0,0,0,0.06)] hover:shadow-[0_16px_50px_rgba(26,115,232,0.25)] hover:border-[var(--google-blue)] transition-all duration-300 relative overflow-hidden">
          ...
          <div className="relative z-10 space-y-2">
            ...
            <div className="mt-3 w-full text-[13px] font-bold text-[#202124] dark:text-[#e8eaed] flex items-center justify-between transition-colors p-2.5 rounded-none bg-gray-50 dark:bg-white group-hover:bg-[#e8f0fe] dark:group-hover:bg-[#174ea6]/20 group-hover:text-[var(--google-blue)] dark:group-hover:text-[#8ab4f8]">
      ...
      <Link href="/blog?tag=민원안내" className="block group">
        <div className="bg-white dark:bg-[#1e1f22]  p-5 rounded-none border border-gray-100 dark:border-white/5 shadow-[0_20px_60px_rgba(0,0,0,0.06)] dark:shadow-[0_20px_60px_rgba(0,0,0,0.06)] hover:shadow-[0_16px_50px_rgba(239,68,68,0.25)] hover:border-red-500 transition-all duration-300 relative overflow-hidden">
          ...
          <div className="relative z-10 space-y-2">
            ...
            <div className="mt-3 w-full text-[13px] font-bold text-[#202124] dark:text-[#e8eaed] flex items-center justify-between transition-colors p-2.5 rounded-none bg-gray-50 dark:bg-white group-hover:bg-red-50 dark:group-hover:bg-red-950/20 group-hover:text-red-500 dark:group-hover:text-red-400">
              <div className="flex items-center gap-2">
                민원 서비스 바로가기
              </div>
              <svg className="w-4 h-4 transition-transform duration-300 group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg>
      ...
      <Link href="/blog?category=혜택" className="block group">
        <div className="bg-white dark:bg-[#1e1f22]  p-5 rounded-none border border-gray-100 dark:border-white/5 shadow-[0_20px_60px_rgba(0,0,0,0.06)] dark:shadow-[0_20px_60px_rgba(0,0,0,0.06)] hover:shadow-[0_16px_50px_rgba(19,115,51,0.25)] hover:border-[#137333] transition-all duration-300 relative overflow-hidden">
          <div className="absolute right-[-10px] bottom-[-20px] opacity-[0.03] dark:opacity-[0.05] text-[90px] select-none pointer-events-none group-hover:scale-110 group-hover:rotate-6 transition-transform duration-300">🏠</div>
          <div className="relative z-10 space-y-2">
            <div className="flex items-center justify-between">
              <h3 className="text-sm font-bold text-[#202124] dark:text-[#e8eaed] flex items-center gap-2 bg-gradient-to-r from-gray-50 to-transparent dark:from-white/5 dark:to-transparent px-2.5 py-1.5">
            ...
            <div className="mt-3 w-full text-[13px] font-bold text-[#202124] dark:text-[#e8eaed] flex items-center justify-between transition-colors p-2.5 rounded-none bg-gray-50 dark:bg-white group-hover:bg-green-50 dark:group-hover:bg-green-950/20 group-hover:text-[#137333] dark:group-hover:text-[#81c995]">
              <div className="flex items-center gap-2">
                지원 조건 확인하기
              </div>
              <svg className="w-4 h-4 transition-transform duration-300 group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg>
      ...
      <Link href="/blog?category=의료" className="block group">
        <div className="bg-white dark:bg-[#1e1f22]  p-5 rounded-none border border-gray-100 dark:border-white/5 shadow-[0_20px_60px_rgba(0,0,0,0.06)] dark:shadow-[0_20px_60px_rgba(0,0,0,0.06)] hover:shadow-[0_16px_50px_rgba(251,188,4,0.3)] hover:border-[var(--google-yellow)] transition-all duration-300 relative overflow-hidden">
          <div className="absolute right-[-10px] bottom-[-20px] opacity-[0.03] dark:opacity-[0.05] text-[90px] select-none pointer-events-none group-hover:scale-110 group-hover:rotate-6 transition-transform duration-300">🩺</div>
          <div className="relative z-10 space-y-2">
            <div className="flex items-center justify-between">
              <h3 className="text-sm font-bold text-[#202124] dark:text-[#e8eaed] flex items-center gap-2 bg-gradient-to-r from-gray-50 to-transparent dark:from-white/5 dark:to-transparent px-2.5 py-1.5">
            ...
            <div className="mt-3 w-full text-[13px] font-bold text-[#202124] dark:text-[#e8eaed] flex items-center justify-between transition-colors p-2.5 rounded-none bg-gray-50 dark:bg-white group-hover:bg-yellow-50 dark:group-hover:bg-yellow-900/20 group-hover:text-yellow-600 dark:group-hover:text-yellow-500">
              <div className="flex items-center gap-2">
                지정 병원 조회하기
              </div>
              <svg className="w-4 h-4 transition-transform duration-300 group-hover:translate-x-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="9 18 15 12 9 6"></polyline></svg>
      ...
      {tags.length > 0 && (
        <div className="bg-white dark:bg-[#1e1f22]  p-5 rounded-none border border-gray-100 dark:border-white/5 shadow-[0_20px_60px_rgba(0,0,0,0.06)] dark:shadow-[0_20px_60px_rgba(0,0,0,0.06)]">
